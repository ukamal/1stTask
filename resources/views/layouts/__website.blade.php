				...
				<div class="wsmain">
					...
					<nav class="wsmenu clearfix">
						<ul class="mobile-sub wsmenu-list">
							<li>
								<a href="javascript:void(0)" class="navtext menuText"><span></span> <span style="color: #f15f2a;">Menu</span></a>
								<div class="wsshoptabing wtsdepartmentmenu clearfix">
									<div class="wsshopwp clearfix">
										<ul class="wstabitem clearfix">
												...
												<div class="wstitemright clearfix computermenubg">
													<div class="wstmegamenucoll01 clearfix">
														...
														<div class="wstheading">
															<a href="{{ url('product_page/'.$category->id) }}" style="color: #6e6e6e;">{{ $category->category_name }}</a> <a href="{{ url('product_page/'.$category->id) }}" class="wstmorebtn">View All</a>
														</div>
											...
											<li>
												<a href="javascript:void(0)"><img width="24px" src="{{ URL::asset('images/main menu/appitizer.png') }}" /> Appitizers</a>
												<div class="wstitemright clearfix">
													<div class="wstmegamenucoll clearfix">
														<?php $appitizers = \App\Category::where('category_slug','appitizers')->first(); ?>
														...
														@foreach($appitizers_products as $category)
															<div class="wstheading">
																<a href="{{ url('product_page/'.$category->id) }}" style="color: #6e6e6e">{{ $category->category_name }} List</a> <a href="{{ url('product_page/'.$category->id) }}" class="wstmorebtn"> View All </a>
															</div>
													...
													<div class="wstmegamenucoll04 clearfix">
														...
														@foreach($rice_and_biriyani_products as $category)
															<ul class="wstliststy05 clearfix">
																...
																@endif
																<li class="wstheading">
																	<a href="{{ url('product_page/'.$category->id) }}" style="color: #6e6e6e">{{ $category->category_name }}</a> <br /> <br /> <a href="{{ url('product_page/'.$category->id) }}"> View All </a>
																</li>
																@foreach($category->products as  $index => $products)
																	@if($index<8)
																		<li>
												...
												<div class="wstitemright clearfix">
													<div class="wstmegamenucoll clearfix">
														...
														@foreach($continental_products as $category)
															<div class="wstheading">
																<a href="{{ url('product_page/'.$category->id) }}" style="color: #6e6e6e">{{ $category->category_name }}  Food Items</a> <a href="{{ url('product_page/'.$category->id) }}" class="wstmorebtn"> View All </a>
															</div>
															<ul class="wstliststy01">
																@foreach($category->products as  $index => $products)
																	<li>
							...
							<li>
								@if (Auth::guest())
									<a href="{{ url('/login') }}" class="navtext"><span class="website_tabs" style="color: #f15f2a;"><i class="fa fa-lock" aria-hidden="true"></i> My Account</span></a>
								@else
