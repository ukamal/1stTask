...
<div class="panel panel-default">
	<div class="panel-heading">
		<span class="my-header"><strong> Registered Customers List </strong></span>
	</div>
						...
						<div class="box box-info">
							<div class="box-body">
								<table id="example1" class="table table-bordered table-striped table-responsive">
									...
									<tbody>
										@if(isset($registered_clients_list))
											@foreach($registered_clients_list as $list)
												@if($list->user_id!='')
													<tr>
														<td>{{ $list->name }}</td>
														<td>{{ $list->email }}</td>
														...
														<td style="text-align: center">
															<a href="{{ url('admin/view_registered_clients_orders_list/'.$list->user_id) }}" data-toggle="view-details" title="View Orders List">
																<i class="fa fa-eye"></i>
															</a>
														</td>
													</tr>
