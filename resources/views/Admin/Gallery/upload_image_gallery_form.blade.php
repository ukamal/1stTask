...
<div class="panel panel-default">
	<div class="panel-heading">
		<span class="my-header"><strong>Upload Gallery Image</strong></span>
	</div>
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="box box-info">
							<div class="box-body">
								<form class="form-horizontal" action="{{ url('admin/upload_gallery_image') }}" method="POST" enctype="multipart/form-data" role="form">
									{!! csrf_field() !!}
									<div class="col-xs-12 col-sm-12">
										<div class="form-group">
											<img id="gallery_image_img" src="{{ URL::asset('images/no-image-available.jpg') }}" width="200px;" />
										</div>
										<div class="form-group">
											<input id="gallery_image" name="image" type="file" class="file-loading image" accept="image/*">
										</div>
									</div>
	...
	function readURL(input) {
		...
		if (input.files && input.files[0]) {
			...
			reader.onload = function(e) {
				$('#gallery_image_img').attr('src', e.target.result);
			}
