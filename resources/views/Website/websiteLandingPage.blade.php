				...
				<div class="col-md-12">
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<ol class="carousel-indicators">
							@foreach($banner_sliders_list as $index => $slider_counters)
								@if($index<1)
						...
						<div class="carousel-inner">
							@foreach($banner_sliders_list as $index => $sliders)
								@if($index<1)
									<div class="item active">
										<img src="{{ URL::asset('images/Banner Sliders/'.$sliders->banner_slider_image) }}" alt="Slider {{ $index }}" style="width:100%;">
									</div>
								@else
									<div class="item">
										<img src="{{ URL::asset('images/Banner Sliders/'.$sliders->banner_slider_image) }}" alt="Slider {{ $index }}" style="width:100%;">
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="my-header" style="color: #f15f2a;"><strong> Programs We Serve </strong></span>
						</div>
						<div class="swin-sc swin-sc-team-slider">
							...
							<div class="team-item swin-transition wow fadeInLeft">
								...
								<p style="color: #f15f2a;" class="team-name">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<span class="my-header" style="color: #f15f2a;"><strong> Our Top Products </strong></span>
						</div>
						<div class="swin-sc swin-sc-team-slider">
							...
							<div class="team-item swin-transition wow fadeInLeft">
								...
								<p class="team-name" style="color: #f15f2a;">
									{{ $product['name'] }}
								</p>
