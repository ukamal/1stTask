...
class WebsiteHomeController extends Controller
{
    ...
    public function landingPage()
    {
		...
		$banner_sliders_list = \App\BannerSliders::all();
  		return view('Website/websiteLandingPage')->with('programs',$programs)->with('product_details',$product_details)->with('banner_sliders_list',$banner_sliders_list);
    }
	...
	public function productPageForPrograms($program_id,$dish_type){
        ...
        if($dish_type == 'Box') {
            $priceColumn = 'box_price';
        }
        else {
            $priceColumn = 'buffet_price';
        }
	...
	public function aboutUs(){
		//dd('here');
		$clients_list = \App\Client::all();
		return view('Website/aboutUs')->with('clients_list',$clients_list);
	}
	...
	public function submitCv(Request $request){
		...
		$file_upload = $request->file('resume');
        $upload = 'resume';
        if($file_upload==null){
            $fileName = '';
        }
        else{
            $fileName = $request->name.'_'.rand().'.'. $file_upload->getClientOriginalExtension();
            $file_upload->move($upload,$fileName);
        }
	   ...
	   $message = 'Your CV has been submitted successfully.';
        ...
        Mail::to($mail_addresses)->send(new sendCurriculumVitae($curriculum_vitae));
	...
	public function submitQuery(Request $request){
	   ...
	   //Mail::to($mail_address)->send(new sendCustomerQuery($query));
